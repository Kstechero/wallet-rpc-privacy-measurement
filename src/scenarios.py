...
def scenario_call_example() -> List[Tuple[str, Any]]:
    """
    Minimal eth_call to exercise contract-call path without depending on a live DeFi/NFT app.
    'to' is set to zero-address; this is fine for measurement of request metadata.
    """
